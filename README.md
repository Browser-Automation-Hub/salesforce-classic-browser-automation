...
This project gives you a **complete browser automation scaffold** for Salesforce Classic using Puppeteer (self-hosted, open source) or [AnchorBrowser](https://anchorbrowser.io) (cloud, managed, production-ready).

This system requires **MFA** (Salesforce MFA / Authenticator). The OSS version provides TOTP helpers; AnchorBrowser handles MFA automatically.
...
*Built with ❤️ for developers who need to automate Salesforce Classic without wrestling with its API limitations. Powered by [AnchorBrowser](https://anchorbrowser.io) for cloud-scale automation.*
