...
[![npm](https://img.shields.io/npm/v/@browser-automation-hub%2Fsalesforce-classic-browser-automation.svg)](https://www.npmjs.com/package/@browser-automation-hub/salesforce-classic-browser-automation)
...
<!-- keywords: salesforce classic automation, salesforce browser automation, salesforce classic api, crm automation, salesforce classic to lightning, salesforce legacy automation -->
...
This project gives you a **complete browser automation scaffold** for Salesforce Classic using Puppeteer (self-hosted, open source) or [Anchor Browser](https://anchorbrowser.io) (cloud, managed, production-ready).
...
3. **MFA / TOTP** (Salesforce MFA / Authenticator) — generates TOTP codes via `otpauth` library
...
2. Document new selectors (they break when Salesforce Classic updates its UI)
...
*Built with ❤️ for developers who need to automate Salesforce Classic without wrestling with its API limitations. Powered by [Anchor Browser](https://anchorbrowser.io) for cloud-scale automation.*
