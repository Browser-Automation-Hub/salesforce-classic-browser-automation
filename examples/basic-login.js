/**
 * basic-login.js — Basic login example for Salesforce Classic
...
async function main() {
  ...
  try {
    log('Starting Salesforce Classic automation (Open Source mode)');
    ...
    const result = await login_salesforce(page, {
    ...
    // const data = await create_lead(page, {});
    // log('Data:', data);
